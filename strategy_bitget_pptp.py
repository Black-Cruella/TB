...
try:
    with open('./TBPPTP/hp_status.txt', 'r') as file:
...
try:
    with open('./TBPPTP/lp_status.txt', 'r') as file:
...
with open('./TBPPTP/hp_status.txt', 'w') as file:
    file.write(str(hp_status))

with open('./TBPPTP/lp_status.txt', 'w') as file:
